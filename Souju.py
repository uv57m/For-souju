...
def txt():
	...
	pen.down() 
	pen.color('deep pink') 
	pen.write("U are the least liked Person\u2764\ufe0f in my life Baby...", font=("Courier", 15, "italic"))
	time.sleep(2)
	pen.up() 
	pen.setpos(-600,-185) 
	pen.down() 
	...
	pen.down() 
	pen.color('deep pink') 
	pen.write("Your boobies is my favorite thing in the world.", font=("Courier", 15, "italic"))
	time.sleep(2)
	pen.up() 
	pen.setpos(-600,-245) 
	pen.down() 
	pen.color('deep pink') 
	pen.write("The way you misunderstand and bully me means more than words can express", font=("Courier", 15, "italic"))
	time.sleep(2)
	pen.up() 
	pen.setpos(-600,-275) 
	pen.down() 
	pen.color('deep pink') 
	pen.write("I am missing 🙁🙁 you boobies every moment Dear", font=("Courier", 15, "italic"))
	time.sleep(2)
	pen.up() 
	pen.setpos(-600,-305) 
	pen.down() 
	pen.color('red') 
	pen.write("I Love you Baby \u2764\ufe0f...You are MINE... HAPPY WOMEN's DAY DEAR", font=("Courier", 15, "italic"))
